import { Chapter, ChapterImages, Manga } from '@duck-manga/shared-types';
 ...
 */
export const useKeyboardScroll = (images?: ChapterImages) => {
 ...
 */
export const getNextChapter = (manga: Manga, chapter?: Chapter) => {
 ...
 */
export const useNextChapterLink = (manga: Manga, chapter?: Chapter) =>
  useMemo(() => {
 ...
 */
export const useGetValidImageNumber = (images?: ChapterImages) => {
