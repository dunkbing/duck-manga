import { Chapter, ChapterImages, Chapters, Manga, MangaList } from '@duck-manga/shared-types';
...
// Chapters
export const setCurrentChapter = createAction<Chapter>('manga/setCurrentChapter');
export const fetchMangaChapters = createAsyncThunk<Chapters, number>(
  'manga/fetchChapters',
  async (id: number) => {
